...
Adafruit_INA219 ina219_load(0x45);
...
float Vref, voltage_pv, voltage_bat, voltage_load;
...
void displayData() {
  ...
  Serial.print(",   BAT: ");
  Serial.print(voltage_bat);
  
  Serial.print(",   LOAD: ");
  Serial.print(voltage_load);
  Serial.print(", Vreferensi: "); Serial.print(Vref);
  Serial.println();
